...
import { getSupplierbyId, updateSupplier } from "../services/apis";
...
export default function UpdateSupplier() {
  ...
  const { data } = useQuery({
    queryKey: ["supplier_by_id"],
    queryFn: () => getSupplierbyId(token, id),
  });
  ...
  const { mutate } = useMutation({
    ...
    mutationFn: (payload) => updateSupplier(token, payload, id),
    onSuccess: () => {
